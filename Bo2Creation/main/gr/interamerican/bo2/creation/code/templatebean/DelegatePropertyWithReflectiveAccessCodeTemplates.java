 ...
 * with direct access. 
 */
public class DelegatePropertyWithReflectiveAccessCodeTemplates 
extends PropertyCodeTemplates {
	...
	private static final String CODE_TEMPLATES_PATH = 
		"/gr/interamerican/bo2/creation/code/templates/property/delegate/reflective/"; //$NON-NLS-1$

	/**
	 * Creates a new CodeTemplates object. 
	 *
	 */
	public DelegatePropertyWithReflectiveAccessCodeTemplates() {		
