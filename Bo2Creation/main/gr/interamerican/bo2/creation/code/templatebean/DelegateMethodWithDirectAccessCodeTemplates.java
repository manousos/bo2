 ...
 */
public class DelegateMethodWithDirectAccessCodeTemplates 
extends MethodCodeTemplates {
	...
	private static final String CODE_TEMPLATES_PATH = 
		"/gr/interamerican/bo2/creation/code/templates/method/delegate/direct/"; //$NON-NLS-1$

	/**
	 * Creates a new EmptyMethodCodeTemplates object. 
	 *
	 */
	public DelegateMethodWithDirectAccessCodeTemplates() {		
