...
public class TestObjectType {
	...
	public void testGet_string() throws SQLException{
		Object expected = rs.getObject("columnIndex"); //$NON-NLS-1$
		Object actual = objectType.get(rs,"columnIndex"); //$NON-NLS-1$
	...
	public void testGet_integer() throws SQLException{
		Object expected = rs.getObject(0); 
		Object actual = objectType.get(rs,0); 
		assertEquals(expected,actual);
