...
public final class StringConstants {
	 ...
	 * question mark (?).
	 */
	public static final String QUESTIONMARK = "?"; //$NON-NLS-1$
	/**
	 * exclamation mark (!).
	 */
	 ...
	 * left curly bracket ({)
	 */
	public static final String LEFT_CURLY_BRACKET = "{"; //$NON-NLS-1$
	/**
	 * right curly bracket (})
	 */
	public static final String RIGHT_CURLY_BRACKET = "}"; //$NON-NLS-1$
