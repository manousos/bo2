...
/**
 * Comparison condition that check that the specified object is greater than
...
implements Condition<T> {
	 ...
	 *        condition.
	 */
	public GreaterThan(Comparator<T> comparator, T comparedValue) {
	 ...
	 *        condition.
	 */
	public GreaterThan(T comparedValue) {
		super(comparedValue);
	}
