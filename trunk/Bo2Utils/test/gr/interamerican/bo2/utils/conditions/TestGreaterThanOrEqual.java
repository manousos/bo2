...
public class TestGreaterThanOrEqual {
	...
	public void testCheck_2() {		
		GreaterThanOrEqual<Integer> gt = new GreaterThanOrEqual<Integer>(5);		
		Assert.assertFalse(gt.check(0));
		Assert.assertFalse(gt.check(4));
		Assert.assertTrue(gt.check(5));
		Assert.assertTrue(gt.check(8));
