 ...
 * with direct access. 
 */
public class Delegate2MapWithDirectAccessCodeTemplates 
extends PropertyCodeTemplates {
	...
	private static final String CODE_TEMPLATES_PATH = 
		"/gr/interamerican/bo2/creation/code/templates/property/delegate2map/direct/"; //$NON-NLS-1$

	/**
	 * Creates a new CodeTemplates object. 
	 *
	 */
	public Delegate2MapWithDirectAccessCodeTemplates() {		
