 ...
 * with direct access. 
 */
public class PropertyWithReflectiveAccessCodeTemplates 
extends PropertyCodeTemplates {
	...
	private static final String CODE_TEMPLATES_PATH = 
		"/gr/interamerican/bo2/creation/code/templates/property/reflective/"; //$NON-NLS-1$

	/**
	 * Creates a new CodeTemplates object. 
	 *
	 */
	public PropertyWithReflectiveAccessCodeTemplates() {		
