 ...
 */
public class AddingCodeToDefaultConstructorClassUpdater 
extends AbstractClassUpdater {
	...
	throws CannotCompileException, NotFoundException {	
		CtConstructor defaultConstructor = typeToUpdate.getConstructor("()V"); //$NON-NLS-1$
		...
		defaultConstructor.insertAfter(newCode);
