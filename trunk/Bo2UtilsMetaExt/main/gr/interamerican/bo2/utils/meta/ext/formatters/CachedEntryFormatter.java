 ...
 *        Type of entry code.
 */
public class CachedEntryFormatter
...
implements Formatter<T> {
	 ...
	 * @param codeFormatter 
	 */
	public CachedEntryFormatter(Formatter<C> codeFormatter) {
	...
	public String format(T t) {
		...
		return codeFormatter.format(t.getCode());
	}
