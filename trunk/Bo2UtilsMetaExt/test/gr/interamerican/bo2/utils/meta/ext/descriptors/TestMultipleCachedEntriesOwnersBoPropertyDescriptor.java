...
/**
 * Unit test for {@link MultipleCachedEntriesOwnersBoPropertyDescriptor}.
 */
public class TestMultipleCachedEntriesOwnersBoPropertyDescriptor {
	...
	MultipleCachedEntriesOwnersBoPropertyDescriptor<ObjectType, Long> descriptor = 
		new MultipleCachedEntriesOwnersBoPropertyDescriptor<ObjectType, Long>(TYPE,SUBTYPE,cache,codesParser, formatter);
	...
	/**
	 * test {@link MultipleCachedEntriesOwnersBoPropertyDescriptor#format(java.util.Collection)}.
	 */
	@Test
	...
	/**
	 * test {@link MultipleCachedEntriesOwnersBoPropertyDescriptor#getValidator()}.
	 */
	@Test
	...
	public void testValidate() throws ValidationException{
		...
		objectTypesList.add(ObjectType.OBJECT2);
		objectTypesList.add(ObjectType.OBJECT3);
		descriptor.validate(objectTypesList);
	}
	
	/**
	 * test {@link MultipleCachedEntriesOwnersBoPropertyDescriptor#getSelectableValues()}.
	 */
	@Test
	...
	/**
	 *  Test {@link MultipleCachedEntriesOwnersBoPropertyDescriptor#getFormatter()}.
	 */
	@Test
