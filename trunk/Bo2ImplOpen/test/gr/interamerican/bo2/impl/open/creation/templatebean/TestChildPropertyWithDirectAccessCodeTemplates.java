 ...
 */
public class TestChildPropertyWithDirectAccessCodeTemplates 
extends TestPropertyCodeTemplates {
	 ...
	 *
	 */
	public TestChildPropertyWithDirectAccessCodeTemplates() {
		super(new ChildPropertyWithDirectAccessCodeTemplates());
	}
