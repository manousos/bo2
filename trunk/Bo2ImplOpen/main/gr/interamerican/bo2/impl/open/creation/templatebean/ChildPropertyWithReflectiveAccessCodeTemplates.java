 ...
 * with direct access. 
 */
public class ChildPropertyWithReflectiveAccessCodeTemplates 
extends PropertyCodeTemplates {
	...
	private static final String CODE_TEMPLATES_PATH = 
		"/gr/interamerican/bo2/impl/open/creation/templates/property/child/reflective/"; //$NON-NLS-1$

	/**
	 * Creates a new CodeTemplates object. 
	 *
	 */
	public ChildPropertyWithReflectiveAccessCodeTemplates() {		
