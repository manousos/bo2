 ...
 * with direct access. 
 */
public class ChildPropertyWithDirectAccessCodeTemplates 
extends PropertyCodeTemplates {
	...
	private static final String CODE_TEMPLATES_PATH = 
		"/gr/interamerican/bo2/impl/open/creation/templates/property/child/direct/"; //$NON-NLS-1$

	/**
	 * Creates a new CodeTemplates object. 
	 *
	 */
	public ChildPropertyWithDirectAccessCodeTemplates() {		
