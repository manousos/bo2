...
extends AbstractResourceConsumer {
	...
	private String getFirstStatementKey() {
		return this.statements.keySet().iterator().next();
	}
	 ...
	 * @throws DataException
	 */
	private void processAnnotatedMethods() 
	throws DataException {
	 ...
	 * @param params
	 */
	private void logStatement(String statement, Object[] params) {
	 ...
	 * @throws SQLException
	 */
	protected int executeUpdatePs(PreparedStatement ps) 
	throws SQLException {
		try {
