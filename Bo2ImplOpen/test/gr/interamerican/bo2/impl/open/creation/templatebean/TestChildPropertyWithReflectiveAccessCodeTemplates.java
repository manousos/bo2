 ...
 */
public class TestChildPropertyWithReflectiveAccessCodeTemplates 
extends TestPropertyCodeTemplates {
	 ...
	 *
	 */
	public TestChildPropertyWithReflectiveAccessCodeTemplates() {
		super(new ChildPropertyWithReflectiveAccessCodeTemplates());
	}
