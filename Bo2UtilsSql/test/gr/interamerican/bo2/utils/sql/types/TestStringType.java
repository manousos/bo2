...
public class TestStringType {
	...
	public void testGet_string() throws SQLException{
		String expected = rs.getString("columnIndex"); //$NON-NLS-1$
		String actual = stringType.get(rs,"columnIndex"); //$NON-NLS-1$
	...
	public void testGet_integer() throws SQLException{
		String expected = rs.getString(0); 
		String actual = stringType.get(rs,0); 
		assertEquals(expected,actual);
