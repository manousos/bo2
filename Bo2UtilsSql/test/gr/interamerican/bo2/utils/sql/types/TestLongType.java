...
public class TestLongType {
	...
	public void testGet_string() throws SQLException{
		Long expected = rs.getLong("columnIndex"); //$NON-NLS-1$
		Long actual = longType.get(rs,"columnIndex"); //$NON-NLS-1$
	...
	public void testGet_integer() throws SQLException{
		Long expected = rs.getLong(0); 
		Long actual = longType.get(rs,0); 
		assertEquals(expected,actual);
