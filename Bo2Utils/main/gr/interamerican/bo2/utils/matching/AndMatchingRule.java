...
/**
 * Matching rule that checks an array of matching rules trying
 * to match them all.
 * 
 * If all matching rules of the array match, then the match is true. 
 * 
 * @param <F> Type of first object.
 * @param <S> Type of second object.
 */
public class AndMatchingRule<F,S> implements MatchingRule<F, S> {
	/**
