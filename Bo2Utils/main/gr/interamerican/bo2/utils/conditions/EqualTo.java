...
/**
 * Comparison condition that check that the specified object is equal to
 * an object that is specified at the constructor of the condition.
 * 
 * @param <T> 
...
implements Condition<T> {
	 ...
	 *        condition.
	 */
	public EqualTo(Comparator<T> comparator, T comparedValue) {
	 ...
	 *        condition.
	 */
	public EqualTo(T comparedValue) {
		super(comparedValue);
	}
