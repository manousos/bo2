...
@SuiteClasses(
	{	
		TestArray.class,
		TestAssociationTable.class,
		TestPropertiesInitializedBean.class,
		TestFolderInitializedBean.class,
		TestRange.class,
		TestAnyRange.class,
		TestNull.class,
		TestPair.class,
		TestConditionalStringBuilder.class,
		TestTypeBasedSelection.class,
		TestTree.class,
		TestAbstractObjectStructureAnalyzer.class,
		TestExpressionBasedSelection.class,
		TestMessageGetter.class,
		TestBdCalculator.class,
		TestCalculatePercentageWithFixedRounding.class,
