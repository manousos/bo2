...
import gr.interamerican.bo2.samples.jasper.SampleJasperReportOperation;

import org.junit.Test;

/**
 * Unit test for {@link JasperReportOperation}.
 */
	...
	throws LogicException, DataException, UnexpectedException {
		new AbstractBo2RuntimeCmd() {
			...
			public void work() throws LogicException, DataException, InitializationException, UnexpectedException {
				SampleJasperReportOperation op = create(SampleJasperReportOperation.class);
