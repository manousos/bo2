...
import gr.interamerican.bo2.samples.jasper.SampleEntitiesQueryJasperReportOperation;
 ...
 * 
 */
public class TestEntitiesQueryJasperReportOperation {
	...
	throws LogicException, DataException, UnexpectedException {
		new AbstractBo2RuntimeCmd() {
			...
			public void work() throws LogicException, DataException, InitializationException, UnexpectedException {
				SampleEntitiesQueryJasperReportOperation op = new SampleEntitiesQueryJasperReportOperation();
